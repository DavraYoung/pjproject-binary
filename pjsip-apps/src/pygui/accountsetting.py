...
class Dialog(tk.Toplevel):
    ...
    def createBasicTab(self):
        ...
        row += 1
        ttk.Label(frm, text="Registrar URI:").grid(
        ...
        row += 1
        ttk.Checkbutton(
            frm, text="Register on add", variable=self.cfgRegisterOnAdd
        ).grid(row=row, column=1, sticky=tk.W, padx=6, pady=2)
        row += 1
        ttk.Label(frm, text="Optional proxy URI:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ...
        row += 1
        ttk.Label(frm, text="Auth username:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
    ...
    def createSipTab(self):
        ...
        frm.columnconfigure(1, weight=2)
        row = 0
        ttk.Label(frm, text="100rel/PRACK:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ttk.Radiobutton(
            frm,
        ...
        row += 1
        ttk.Label(frm, text="Session Timer:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ttk.Radiobutton(
            frm,
        ...
        tk.Spinbox(
            frm, from_=90, to=7200, textvariable=self.cfgTimerExpires, width=5
        ).grid(row=row, column=1, sticky=tk.W, padx=6)
        ...
        row += 1
        ttk.Label(frm, text="NAT Traversal:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ttk.Checkbutton(
        ...
        row += 1
        ttk.Checkbutton(
            frm, text="Enable Via Rewrite", variable=self.cfgEnableViaRewrite
        ).grid(row=row, column=1, sticky=tk.W, padx=6, pady=2)
        row += 1
        ttk.Checkbutton(
        ...
        ttk.Checkbutton(
            ...
            variable=self.cfgEnableSipOutbound,
        ).grid(row=row, column=1, sticky=tk.W, padx=6, pady=2)
        row += 1
        ttk.Label(frm, text="UDP Keep-Alive Interval:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        tk.Spinbox(
            frm, from_=0, to=3600, textvariable=self.cfgKaInterval, width=5
        ).grid(row=row, column=1, sticky=tk.W, padx=6)
        ttk.Label(frm, text="(seconds) Zero to disable.").grid(
    ...
    def createMediaTab(self):
        ...
        row = 0
        ttk.Label(frm, text="Secure RTP (SRTP):").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ttk.Radiobutton(
            frm,
        ...
        row += 1
        ttk.Label(frm, text="SRTP signaling:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ttk.Radiobutton(
            frm,
            ...
            value=0,
            variable=self.cfgMedSrtpSecure,
        ).grid(row=row, column=1, sticky=tk.W, padx=6)
        row += 1
        ttk.Radiobutton(
            frm,
        ...
        tk.Spinbox(
            frm, from_=0, to=65535, textvariable=self.cfgMedPortRange, width=5
        ).grid(row=row, column=1, sticky=tk.W, padx=6)
        ttk.Label(frm, text="(0: not limited)").grid(
    ...
    def createMediaNatTab(self):
        ...
        frm.columnconfigure(1, weight=2)
        row = 0
        ttk.Label(frm, text="SIP STUN Usage:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ttk.Radiobutton(
            frm,
        ...
        row += 1
        ttk.Label(frm, text="Media STUN Usage:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ttk.Radiobutton(
            frm,
        ...
        row += 1
        ttk.Checkbutton(
            frm, text="Use aggresive nomination", variable=self.cfgIceAggressive
        ).grid(row=row, column=1, sticky=tk.W, padx=6, pady=2)
        row += 1
        ttk.Checkbutton(
            frm,
            text="Always re-INVITE after negotiation",
            variable=self.cfgAlwaysUpdate,
        ).grid(row=row, column=1, sticky=tk.W, padx=6, pady=2)
        row += 1
        ttk.Checkbutton(
            frm, text="Disable host candidates", variable=self.cfgIceNoHostCands
        ).grid(row=row, column=1, sticky=tk.W, padx=6, pady=2)
        row += 1
        ...
        row += 1
        ttk.Label(frm, text="TURN connection:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ttk.Radiobutton(
        ...
        row += 1
        ttk.Label(frm, text="TURN username:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
        ...
        row += 1
        ttk.Label(frm, text="TURN password:").grid(
            row=row, column=0, sticky=tk.E, pady=2
        )
    ...
    def onOk(self):
        ...
        self.cfg.natConfig.contactRewriteUse = (
            1 if self.cfgEnableContactRewrite.get() else 0
        )
