...
class LogWindow(tk.Toplevel):
    ...
    def _createWidgets(self):
        ...
        self.text.tag_configure(
            "trace", font=("Courier New", "8"), foreground="#777777"
        )
        self.text.tag_configure(
            "info", font=("Courier New", "8", "bold"), foreground="black"
        )
        self.text.tag_configure(
            "warning", font=("Courier New", "8", "bold"), foreground="cyan"
        )
        self.text.tag_configure(
            "error", font=("Courier New", "8", "bold"), foreground="red"
        )
