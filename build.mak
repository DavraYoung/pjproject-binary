export PJDIR := /app/pjproject-binary
...
# FFMPEG flags
FFMPEG_CFLAGS =  -DPJMEDIA_HAS_LIBAVDEVICE=1 -DPJMEDIA_HAS_LIBAVFORMAT=1 -DPJMEDIA_HAS_LIBAVCODEC=1 -DPJMEDIA_HAS_LIBSWSCALE=1 -DPJMEDIA_HAS_LIBAVUTIL=1 -I/usr/local/include 
FFMPEG_LDFLAGS =   -L/usr/local/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil
...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
         -fPIC -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1 -fPIC\
        $(PJ_VIDEO_CFLAGS) \
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
        ...
        $(APP_THIRD_PARTY_EXT)\
        $(PJLIB_LDLIB) \
        -lopus -lm -lrt -lpthread  -lasound  -L/usr/local/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil -lopencore-amrnb -lopencore-amrwb
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -lopus -lm -lrt -lpthread  -lasound  -L/usr/local/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil -lopencore-amrnb -lopencore-amrwb
